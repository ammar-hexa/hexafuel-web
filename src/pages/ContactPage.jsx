...
function ContactPage() {
  ...
  return (
    <>
      {/* Header section */}
      <section className={`w-100 d-flex align-items-center justify-content-center bg-gradient py-5`}>
        <div className="container text-center py-5">
          <div
            className={`badge btn ${isColorTheme(theme) ? `bg-${theme}-subtle` : theme === Theme.LIGHT ? 'bg-body-tertiary' : 'bg-body-secondary'} text-body-secondary mb-3 px-4 py-2`}
            onClick={() => {}}
          >
            Get Started Today
          </div>
          ...
          <p
            className="lead text-body-secondary mb-0"
        ...
        <div className="container">
          <div className="row justify-content-center align-items-start g-5 w-100 mx-auto">
            ...
            <div className="col-12 col-lg-7 mb-4 mb-lg-0 p-0">
              <div className={`${isColorTheme(theme) && "text-"+theme} rounded-3 shadow p-4 p-md-5 ${theme === Theme.DARK && "bg-body-secondary"}`}>
                ...
                <form className="contact-form" autoComplete="off">
                  ...
                  <button
                    type="submit"
                    className={`btn btn-${isColorTheme(theme) ? theme : theme === Theme.DARK ? "secondary" : "dark"} w-100 fw-semibold mt-4`}
                    style={{ borderRadius: 8 }}
                  >
                    Start Free Trial
                  </button>
                  <div
                    className={`text-center mt-3 text-body-secondary`}
            ...
            <div className="col-12 col-lg-5 p-0">
              ...
              >
                <h4 className={`fw-bold mb-3 ${isColorTheme(theme) && "text-"+theme} `}>Get in Touch</h4>
                <p
                  className="text-secondary mb-4"
                  style={{ fontSize: "1.05rem" }}
                >
                ...
                <ul className="list-unstyled m-0">
                  <li className="m-0 mb-4 d-flex align-items-start">
                    <span className={`me-3 fs-4 ${isColorTheme(theme) && "text-"+theme}`}>
                      <Envelope />
                    </span>
                    <div>
                  ...
                  <li className="mb-4 d-flex align-items-start">
                    ...
                    <div>
                      ...
                      <div>
                        Hexalogicx Software House & Institute
                        <br />
                        Daad Market Near School #3 Kheror Road
                        <br />
                        Lodhran
      ...
      <section className="py-5 bg-body-tertiary">
        <div className="container">
          <div className="text-center mb-5">
            <h2 className={`fw-bold mb-2 ${isColorTheme(theme) && "text-"+theme}`}>Why choose HexaFuel?</h2>
            <p
          ...
          <div className="row justify-content-center g-4">
            <div className="col-12 col-md-6 col-lg-4 d-flex justify-content-center">
              <div
                className={`${theme === Theme.DARK ? "bg-body-secondary" : "bg-white"} rounded-3 shadow-sm p-4 w-100 text-center`}
                style={{
                  maxWidth: 340,
                  minHeight: 180,
                }}
              >
                ...
                <div
                  className={`fw-semibold mb-1 ${isColorTheme(theme) && "text-"+theme}`}
      ...
      <section className="py-5">
        <div className="container">
          <div className="text-center my-5">
            <h2 className={`fw-bold mb-2 ${isColorTheme(theme) && "text-"+theme}`}>Still have questions?</h2>
            <p
